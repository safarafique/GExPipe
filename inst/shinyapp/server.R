...
server <- function(input, output, session) {
  ...
  # Server modules (installed in R/server_*.R; no runtime source() from inst/)
  .gexpipe_call("server_download", input, output, session, rv)
  .gexpipe_call("server_qc", input, output, session, rv)
  .gexpipe_call("server_normalize", input, output, session, rv)
  .gexpipe_call("server_batch", input, output, session, rv)
  .gexpipe_call("server_results", input, output, session, rv)
  .gexpipe_call("server_wgcna", input, output, session, rv)
  .gexpipe_call("server_common_genes", input, output, session, rv)
  .gexpipe_call("server_ppi", input, output, session, rv)
  .gexpipe_call("server_ml", input, output, session, rv)
  .gexpipe_call("server_validation", input, output, session, rv)
  .gexpipe_call("server_roc", input, output, session, rv)
  .gexpipe_call("server_nomogram", input, output, session, rv)
  .gexpipe_call("server_gsea", input, output, session, rv)
  .gexpipe_call("server_results_summary", input, output, session, rv)
  .gexpipe_call("server_groups", input, output, session, rv)
