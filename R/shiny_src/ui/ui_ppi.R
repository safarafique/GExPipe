  ...
  fluidRow(
    box(
      ...
      fluidRow(
        column(
          ...
          numericInput("ppi_score_threshold",
            tags$span(
              "STRING score threshold (150–900)",
              tags$i(
      ...
      tags$p(tags$strong("Step 1:"), " Run PPI to find interacting and non-interacting genes (counts and list below). ",
        tags$strong("Step 2:"), " Use the network graphs further down for the selected interacting genes.",
        style = "margin-top: 12px; color: #495057;"
      )
    )
  ),
  fluidRow(
