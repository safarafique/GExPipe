        ...
        fluidRow(
          column(
            ...
            conditionalPanel(
              ...
              numericInput("wgcna_top_genes",
                label = tags$span(
                  tags$strong("Top Variable Genes:"),
                  tags$i(
                    class = "fa fa-question-circle param-help",
                    `data-toggle` = "tooltip", `data-placement` = "right",
          ...
          column(
            ...
            numericInput("wgcna_min_samples",
              label = tags$span(
                tags$strong("Min Samples per Gene (fraction):"),
                tags$i(
                  class = "fa fa-question-circle param-help",
                  `data-toggle` = "tooltip", `data-placement` = "right",
          ...
          fluidRow(
            column(
              ...
              numericInput("wgcna_power",
                label = tags$span(
                  tags$strong("Soft Threshold Power:"),
                  tags$i(
                    class = "fa fa-question-circle param-help",
                    `data-toggle` = "tooltip", `data-placement` = "right",
          ...
          fluidRow(
            column(
              ...
              selectInput("wgcna_deep_split",
                label = tags$span(
                  tags$strong("Deep split (sensitivity):"),
                  tags$i(
                    class = "fa fa-question-circle param-help",
                    `data-toggle` = "tooltip", `data-placement` = "right",
          ...
          fluidRow(
            column(
              ...
              numericInput("gs_pval_threshold",
                label = tags$span(
                  tags$strong("Gene Sig (GS) P-value Threshold:"),
                  tags$i(
                    class = "fa fa-question-circle param-help", `data-toggle` = "tooltip", `data-placement` = "top",
            ...
            column(
              ...
              numericInput("mm_cor_threshold",
                label = tags$span(
                  tags$strong("Module Membership (MM) Threshold:"),
                  tags$i(
                    class = "fa fa-question-circle param-help", `data-toggle` = "tooltip", `data-placement` = "top",
          ...
          fluidRow(
            ...
            column(
              ...
              numericInput("sig_module_cor_threshold",
                label = tags$span(
                  tags$strong("Correlation Threshold:"),
                  tags$i(
                    class = "fa fa-question-circle param-help",
                    `data-toggle` = "tooltip", `data-placement` = "top",
