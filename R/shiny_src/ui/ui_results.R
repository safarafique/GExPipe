...
ui_results <- tabItem(
  ...
  fluidRow(
    box(
      ...
      column(
        3,
        numericInput("logfc_cutoff", tags$span(
          "LogFC cutoff:",
          tags$i(
      ...
      column(
        3,
        numericInput("padj_cutoff", tags$span(
          "Adj. P-value:",
          tags$i(
            class = "fa fa-question-circle param-help",
            `data-toggle` = "tooltip", `data-placement` = "top",
      ...
      column(
        3,
        numericInput("top_genes", tags$span(
          "Heatmap Genes:",
          tags$i(
            class = "fa fa-question-circle param-help",
            `data-toggle` = "tooltip", `data-placement` = "top",
  ...
  fluidRow(
    box(
      title = tags$span(icon("mountain"), " Volcano Plot"),
    ...
    box(
      title = tags$span(icon("list-ol"), " Top DEGs"),
  ...
  fluidRow(
    box(
      title = tags$span(icon("th"), " Heatmap - Top DE Genes"),
