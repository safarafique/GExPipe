          ...
          fluidRow(
            column(3, numericInput("logfc_cutoff", tags$span("LogFC cutoff:",
              tags$i(class = "fa fa-question-circle param-help",
                     ...
                     title = "Log2 fold-change threshold. Genes with |log2FC| above this value are considered differentially expressed.<br><b>0.5</b> = mild (1.4-fold), <b>1.0</b> = strong (2-fold), <b>1.5</b> = very strong (2.8-fold). Range 0-2.")),
