...
gexp_app_head <- function() {
      ...
      # As long as the user interacted within the last 60 minutes, ping the server
      # every 15s so real bytes keep flowing and nothing decides the connection is
      # dead. Once idle exceeds 60 minutes, stop pinging and let it disconnect.
      shiny::tags$script(shiny::HTML("
        (function() {
          var GEXP_IDLE_LIMIT_MS = 60 * 60 * 1000;
