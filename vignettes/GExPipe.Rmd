...
This vignette walks through the **GExPipe Shiny application**: download
GEO data, run QC and normalization, correct batch effects, discover
differentially expressed genes, build co-expression networks, refine
candidates with PPI and machine learning, and export a clinical summary
report.
