...
2. Under **Select Phenotype Columns** (panel a), pick the condition column
   per dataset (e.g. `characteristics_ch1` for `GSE50760`,
   `characteristics_ch1.1` for `GSE104836`).
3. Click **Extract Groups from Selected Columns**.
4. **Categorize Groups** — map labels to Normal / Disease / None.
5. Click **Apply Categorization**.
6. Confirm **Group Summary** (panel b) — at least one Normal and one
   Disease sample required for Step 6 DE.
7. Click **Next: Batch Correction**.
